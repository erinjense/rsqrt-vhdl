...
% lzc_vect is the initial "x" input.
% lzc_vect is expected to be unsigned with W=34,F=17

% This functionality was generated by a MATLAB script

% This function was created using modified VHDL logic 
% by the following Author:
%
% Author: Ross K. Snider, Ph.D., Montana State University
% email address: rksnider@ece.montana.edu
%
% This file is excluded from the GNU license
% All right reserved to Ross K. Snider until further notice
